...
After which, you run get_ERMES_params() using your SCOTTY .h5 file to get the necessary full-wave parameters.
...
If you are using a different full-wave solver, you can take inspiration from this. For example, a csv dataset of ne and B can easily be mapped to work with this.
